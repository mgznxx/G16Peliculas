...
<body>
    <div class="contenedorFormularioRegistroPeliculas">  
        <form action ="registroPeli.php" method = "post"  class="formularioRegistroPeliculas">
            ...
            <div> 
                ...
                <div class="botonesFormularioRegistroPeliculas">
                    ...
                    <button class="btn btn-primary" type="submit" name="enviar"> Registrar Pelicula </button>
                </div>
            </div>
        </form>
